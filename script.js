...
function fetchTopKabupaten() {
    ...
    document.getElementById('top-kab-robusta').innerText = topRobKab;
    document.getElementById('top-val-robusta').innerText = formatNumber(Math.round(topRobVal)) + " Ton";
    document.getElementById('top-kab-arabika').innerText = topAraKab;
